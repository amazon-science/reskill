...
def alfworld_projection(actions: List[str], action_pools: List[List[str]], require_think=True):
    """
    ...
    require_think: whether to require <think> tags (default True).
    """
    ...
    for i in range(len(actions)):
        ...
        # check <think>...</think> (only if required)
        if require_think:
